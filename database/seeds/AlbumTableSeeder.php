  ...
  public function run()
  {
    ...
    foreach ($artists as $artist) {
      switch ($artist->slug) {
        ...
        case 'living_legends':
          // Create the following.
          $file = Files::where('filename', '=', 'Almost_Famous.jpg')->first();
          ...
          $file = Files::where('filename', '=', 'Creativecover.jpg')->first();
        ...
        case 'hieroglyphics':
          ...
          $file = Files::where('filename', '=', 'Full_Circle.jpg')->first();
        ...
        case 'serj_tankian':
          ...
          $file = Files::where('filename', '=', 'Imperfect_Harmonies.jpg')->first();
